...
const outcomes = ["Saved places", "Fast booking", "Trusted reviews"];
...
export default function LoginPage() {
  ...
  return (
    <AuthShell
      title="Welcome back"
      subtitle="Save better places. Book faster. Plan smarter across Rwanda."
      eyebrow="Customer access"
      panelTitle="Your trusted Rwanda list starts here."
      panelSubtitle="Log in to keep saved places, bookings, reviews, and plans ready whenever you need them."
      panelItems={[
        {
          title: "Saved places",
          text: "Restaurants, stays, events, and experiences in one trusted list.",
        },
        {
          title: "Faster actions",
          text: "Return to options you already trust instead of starting over.",
        },
        {
          title: "Verified identity",
          text: "Email and phone verification help protect real bookings.",
        },
      ]}
    >
